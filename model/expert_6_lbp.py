...
class MyModel(tf.keras.models.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        lbp_x2_2 = self.lbp_seblock_2(tf.abs(lbp_x2_2 - lbp_x2_1)) * lbp_x2_2
        ...
        lbp_x3_2 = self.lbp_seblock_3(tf.abs(lbp_x3_2 - lbp_x3_1)) * lbp_x3_2
        ...
        lbp_x4_2 = self.lbp_seblock_4(tf.abs(lbp_x4_2 - lbp_x4_1)) * lbp_x4_2
